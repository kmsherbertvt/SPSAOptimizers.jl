...
Plots.savefig(convergence, "$fig_dir/dimensions.convergence.pdf")
...
Plots.savefig(cost, "$fig_dir/dimensions.cost.pdf")
...
Plots.savefig(trajectory, "$fig_dir/dimensions.trajectory.pdf")
